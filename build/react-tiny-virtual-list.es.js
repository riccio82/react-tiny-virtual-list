...
var transformProp = (_f = {}, _f[DIRECTION.VERTICAL] = 'translateY', _f[DIRECTION.HORIZONTAL] = 'translateX', _f);
var _a;
var _b;
var _c;
var _d;
...
var VirtualList = /** @class */function (_super) {
    ...
    VirtualList.prototype.render = function () {
        ...
        // @ts-ignore
        // @ts-ignore
        return createElement("div", __assign({ ref: this.getRootNodeRef }, props, { onScroll: function (e) {
                return _this.handleScroll(e);
            }, style: __assign({}, STYLE_WRAPPER, style, { height: height, width: width }) }), createElement("div", { ref: this.getInnerNodeRef, style: __assign({}, STYLE_INNER, (_f = { willChange: scrollToTransition === undefined ? null : 'transform' }, _f[sizeProp[scrollDirection]] = this.sizeAndPositionManager.getTotalSize(), _f)) }, items));
        var _e, _f;
    };
